...
part of 'chart_category_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ChartCategoryModel _$ChartCategoryModelFromJson(Map<String, dynamic> json) =>
    ChartCategoryModel()
      ..id = json['id'] as int?
      ...
      ..children = (json['children'] as List<dynamic>?)
          ?.map((e) => ChartCategoryModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ...
      ..contents = (json['contents'] as List<dynamic>?)
          ?.map((e) => ChartContentModel.fromJson(e as Map<String, dynamic>))
          .toList()
...
Map<String, dynamic> _$ChartCategoryModelToJson(ChartCategoryModel instance) =>
    <String, dynamic>{
      'id': instance.id,
