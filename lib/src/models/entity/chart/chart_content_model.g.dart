...
ChartContentModel _$ChartContentModelFromJson(Map<String, dynamic> json) =>
    ChartContentModel()
      ..id = json['id'] as int?
      ...
      ..comments = json['comments'] == null
          ? null
          : ChartCommentModel.fromJson(json['comments'] as Map<String, dynamic>)
      ...
      ..contentTags = (json['contentTags'] as List<dynamic>?)
          ?.map((e) => ChartContentTagModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..similars = (json['similars'] as List<dynamic>?)
          ?.map((e) =>
              ChartContentSimilarModel.fromJson(e as Map<String, dynamic>))
          .toList()
      ..contentCategores = (json['contentCategores'] as List<dynamic>?)
          ?.map((e) =>
              ChartContentCategoryModel.fromJson(e as Map<String, dynamic>))
          .toList()
...
Map<String, dynamic> _$ChartContentModelToJson(ChartContentModel instance) =>
    <String, dynamic>{
      'id': instance.id,
